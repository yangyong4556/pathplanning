...
function [fMin , bestX, Convergence_curve] = DBO(popsize, maxIter,lb,ub,dim,fobj  )

P_percent = 0.2;    % The population size of producers accounts for "P_percent" percent of the total population size


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pNum = round( popsize *  P_percent );    % The population size of the producers
...
for t = 1 : maxIter
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for i = ( pNum + 1 ) :round(popsize*0.45)                  % Equation (4)
        x( i, : )=bestXX+((rand(1,dim)).*(pX( i , : )-Xnew1)+(rand(1,dim)).*(pX( i , : )-Xnew2));
        x(i, : ) = Bounds( x(i, : ), Xnew1, Xnew2 );
        fit(i ) = fobj(  x(i,:) ) ;
    end

    for i = round(popsize*0.45) +1: round(popsize*0.75)                  % Equation (6)
    ...
    for j = round(popsize*0.75) +1 : popsize                 % Equation (7)
